...
public interface UnifiedUserMng {
	...
	public UnifiedUser save(String username, String email, String password,
			String ip, Boolean activation, EmailSender sender, MessageTemplate msgTpl,String encrypt)throws UnsupportedEncodingException, MessagingException;
