...
import static com.hx.cms.Constants.TPLDIR_INDEX;
import static com.hx.cms.action.front.DynamicPageAct.TPL_INDEX;
...
import com.hx.common.web.Constants;
...
public class StaticPageSvcImpl implements StaticPageSvc, InitializingBean {
	...
	@Transactional
	public boolean content(Content content,boolean noNeed) throws IOException, TemplateException {
		Map<String, Object> data = new HashMap<String, Object>();
		long time = System.currentTimeMillis();
		boolean generated = staticPageDao.contentStatic(content, conf, data,noNeed);
		time = System.currentTimeMillis() - time;
		log.info("create content page in {} ms", time);
		return generated;
	}
