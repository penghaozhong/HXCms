...
public interface CmsUserMng {
	...
	public CmsUser registerMember(String username, String email,
			String password, String ip, Integer groupId, CmsUserExt userExt,String encryp);
	...
	public CmsUser registerMember(String username, String email,
			String password, String ip, Integer groupId, CmsUserExt userExt, Boolean activation , EmailSender sender, MessageTemplate msgTpl,String encryp)throws UnsupportedEncodingException, MessagingException ;
