...
import com.hx.cms.manager.main.ChannelExtMng;
import com.hx.cms.manager.main.ChannelMng;
import com.hx.cms.manager.main.ChannelTxtMng;
...
public class ChannelMngImpl implements ChannelMng {
	...
	public List<Channel> getTopList(Integer siteId, boolean hasContentOnly) {
		return dao.getTopList(siteId, hasContentOnly, false, false,false);
	}
	...
	public List<Channel> getTopListForTag(Integer siteId, boolean hasContentOnly,boolean rand) {
		return dao.getTopList(siteId, hasContentOnly, true, true,rand);
	}
	...
	public List<Channel> getChildList(Integer parentId, boolean hasContentOnly) {
		return dao.getChildList(parentId, hasContentOnly, false, false,false);
	}
	...
	public List<Channel> getChildListForTag(Integer parentId,
		...
		return dao.getChildList(parentId, hasContentOnly, displayOnly, true,rand);
	}
	...
	public Channel updateChannel(Channel channel) {
		return dao.updateChannel(channel);
	}
	...
	public List<Channel> getListByIds(Integer[] ids, Integer siteId,
			boolean hasContentOnly) {
		return dao.getListByIds(ids, siteId, hasContentOnly);
	}
	...
	//获取栏目下tags
	@Override
	public Pagination getPageTags(String name, int channelId, int pageNo,
			int pageSize, boolean cacheable) {
		Pagination page = dao.getPageTag(name, channelId, pageNo, pageSize, cacheable);
		return page;
	}
