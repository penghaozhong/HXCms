...
import com.hx.cms.manager.main.CmsRoleMng;
...
import com.hx.cms.manager.main.CmsUserSiteMng;
...
public class CmsUserMngImpl implements CmsUserMng {
	...
	public CmsUser registerMember(String username, String email,
			String password, String ip, Integer groupId, CmsUserExt userExt,String encrypt){
		UnifiedUser unifiedUser = null;
		if(StringUtils.isEmpty(encrypt)){
			unifiedUser = unifiedUserMng.save(username, email,password, ip);
		}else{
			unifiedUser = unifiedUserMng.save(username, email, password, ip, encrypt);
		}
	...
	public CmsUser registerMember(String username, String email,
			String password, String ip, Integer groupId, CmsUserExt userExt,
			Boolean activation, EmailSender sender, MessageTemplate msgTpl,String encrypt)throws UnsupportedEncodingException, MessagingException{
		UnifiedUser unifiedUser = unifiedUserMng.save(username, email,
				password, ip, activation, sender, msgTpl,encrypt);
		CmsUser user = new CmsUser();
		user.forMember(unifiedUser);
