...
public abstract class BaseContentCheck  implements Serializable {
	...
	private com.hx.cms.entity.main.CmsUser reviewer;
	...
	public com.hx.cms.entity.main.CmsUser getReviewer() {
		return reviewer;
	}

	public void setReviewer(com.hx.cms.entity.main.CmsUser reviewer) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.hx.cms.entity.main.ContentCheck)) return false;
		else {
			com.hx.cms.entity.main.ContentCheck contentCheck = (com.hx.cms.entity.main.ContentCheck) obj;
