...
public abstract class BaseCmsSite  implements Serializable {
	...
	public BaseCmsSite (
		...
		com.hx.cms.entity.main.CmsConfig config,
	...
	private com.hx.cms.entity.main.CmsSiteCompany siteCompany;

	// many to one
	private com.hx.core.entity.Ftp uploadFtp;
	private com.hx.cms.entity.main.CmsConfig config;
	...
	public com.hx.cms.entity.main.CmsSiteCompany getSiteCompany() {
		return siteCompany;
	}

	public void setSiteCompany(com.hx.cms.entity.main.CmsSiteCompany siteCompany) {
	 ...
	 */
	public com.hx.core.entity.Ftp getUploadFtp () {
		return uploadFtp;
	}
	 ...
	 */
	public void setUploadFtp (com.hx.core.entity.Ftp uploadFtp) {
	 ...
	 */
	public com.hx.cms.entity.main.CmsConfig getConfig () {
		return config;
	}
	 ...
	 */
	public void setConfig (com.hx.cms.entity.main.CmsConfig config) {
		this.config = config;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.hx.cms.entity.main.CmsSite)) return false;
		else {
			com.hx.cms.entity.main.CmsSite cmsSite = (com.hx.cms.entity.main.CmsSite) obj;
