...
public abstract class BaseCmsCommentExt  implements Serializable {
	...
	private java.lang.Integer replyCommentId;

	// one to one
	private com.hx.cms.entity.assist.CmsComment comment;
	
	private java.util.Set<com.hx.cms.entity.assist.CmsComment> commentSet;
	...
	public java.util.Set<com.hx.cms.entity.assist.CmsComment> getCommentSet() {
		return commentSet;
	}

	public void setCommentSet(
			java.util.Set<com.hx.cms.entity.assist.CmsComment> commentSet) {
	 ...
	 */
	public com.hx.cms.entity.assist.CmsComment getComment () {
		return comment;
	}
	 ...
	 */
	public void setComment (com.hx.cms.entity.assist.CmsComment comment) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.hx.cms.entity.assist.CmsCommentExt)) return false;
		else {
			com.hx.cms.entity.assist.CmsCommentExt cmsCommentExt = (com.hx.cms.entity.assist.CmsCommentExt) obj;
