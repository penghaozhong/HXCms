package com.hx.cms.entity.assist.base;
...
public abstract class BaseCmsComment  implements Serializable {
	...
	public BaseCmsComment (
		...
		com.hx.cms.entity.main.Content content,
		com.hx.cms.entity.main.CmsTopic topic,
	...
	// 态度
	private java.lang.Short attitude;

	// one to one
	private com.hx.cms.entity.assist.CmsCommentExt commentExt;
	
	private Set<BaseCmsComment> cmsConmentSet;
	

	// many to one
	private com.hx.cms.entity.main.CmsUser replayUser;
	private com.hx.cms.entity.main.Content content;
	private com.hx.cms.entity.main.CmsUser commentUser;
	private com.hx.cms.entity.main.CmsSite site;
	private com.hx.cms.entity.main.CmsTopic topic;
	 ...
	 */
	public com.hx.cms.entity.assist.CmsCommentExt getCommentExt () {
		return commentExt;
	}
	 ...
	 */
	public void setCommentExt (com.hx.cms.entity.assist.CmsCommentExt commentExt) {
	 ...
	 */
	public com.hx.cms.entity.main.CmsUser getReplayUser () {
		return replayUser;
	}
	 ...
	 */
	public void setReplayUser (com.hx.cms.entity.main.CmsUser replayUser) {
	 ...
	 */
	public com.hx.cms.entity.main.Content getContent () {
		return content;
	}
	 ...
	 */
	public void setContent (com.hx.cms.entity.main.Content content) {
	 ...
	 */
	public com.hx.cms.entity.main.CmsUser getCommentUser () {
		return commentUser;
	}
	 ...
	 */
	public void setCommentUser (com.hx.cms.entity.main.CmsUser commentUser) {
	...
	public com.hx.cms.entity.main.CmsTopic getTopic() {
		return topic;
	}

	public void setTopic(com.hx.cms.entity.main.CmsTopic topic) {
		this.topic = topic;
	}

	public java.lang.Short getAttitude() {
		return attitude;
	}

	public void setAttitude(java.lang.Short attitude) {
		this.attitude = attitude;
	}

	public boolean equals (Object obj) {
		if (null == obj) return false;
		if (!(obj instanceof com.hx.cms.entity.assist.CmsComment)) return false;
		else {
			com.hx.cms.entity.assist.CmsComment cmsComment = (com.hx.cms.entity.assist.CmsComment) obj;
