...
public abstract class BaseCmsSiteFlow  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.hx.cms.entity.assist.CmsSiteFlow)) return false;
		else {
			com.hx.cms.entity.assist.CmsSiteFlow cmsSiteFlow = (com.hx.cms.entity.assist.CmsSiteFlow) obj;
