...
public abstract class BaseCmsGuestbook  implements Serializable {
	...
	public BaseCmsGuestbook (
		...
		com.hx.cms.entity.assist.CmsGuestbookCtg ctg,
		java.lang.String ip,
	...
	// one to one
	private com.hx.cms.entity.assist.CmsGuestbookExt ext;

	// many to one
	private com.hx.cms.entity.main.CmsUser member;
	private com.hx.cms.entity.main.CmsUser admin;
	private com.hx.cms.entity.main.CmsSite site;
	private com.hx.cms.entity.assist.CmsGuestbookCtg ctg;
	 ...
	 */
	public com.hx.cms.entity.assist.CmsGuestbookExt getExt () {
		return ext;
	}
	 ...
	 */
	public void setExt (com.hx.cms.entity.assist.CmsGuestbookExt ext) {
		this.ext = ext;
	}
	 ...
	 */
	public com.hx.cms.entity.main.CmsUser getMember () {
		return member;
	}
	 ...
	 */
	public void setMember (com.hx.cms.entity.main.CmsUser member) {
		this.member = member;
	}
	 ...
	 */
	public com.hx.cms.entity.main.CmsUser getAdmin () {
		return admin;
	}
	 ...
	 */
	public void setAdmin (com.hx.cms.entity.main.CmsUser admin) {
		this.admin = admin;
	}
	 ...
	 */
	public com.hx.cms.entity.assist.CmsGuestbookCtg getCtg () {
		return ctg;
	}
	 ...
	 */
	public void setCtg (com.hx.cms.entity.assist.CmsGuestbookCtg ctg) {
		this.ctg = ctg;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.hx.cms.entity.assist.CmsGuestbook)) return false;
		else {
			com.hx.cms.entity.assist.CmsGuestbook cmsGuestbook = (com.hx.cms.entity.assist.CmsGuestbook) obj;
