...
public abstract class BaseCmsVoteSubTopic  implements Serializable {
	...
	public BaseCmsVoteSubTopic (
		...
		com.hx.cms.entity.assist.CmsVoteTopic voteTopic,
	...
	// many to one
	private com.hx.cms.entity.assist.CmsVoteTopic voteTopic;

	// collections
	private java.util.Set<com.hx.cms.entity.assist.CmsVoteItem> voteItems;
	private java.util.Set<com.hx.cms.entity.assist.CmsVoteReply> voteReplys;
	 ...
	 */
	public com.hx.cms.entity.assist.CmsVoteTopic getVoteTopic () {
		return voteTopic;
	}
	 ...
	 */
	public void setVoteTopic (com.hx.cms.entity.assist.CmsVoteTopic voteTopic) {
	 ...
	 */
	public java.util.Set<com.hx.cms.entity.assist.CmsVoteItem> getVoteItems () {
		return voteItems;
	}
	 ...
	 */
	public void setVoteItems (java.util.Set<com.hx.cms.entity.assist.CmsVoteItem> voteItems) {
	 ...
	 */
	public java.util.Set<com.hx.cms.entity.assist.CmsVoteReply> getVoteReplys () {
		return voteReplys;
	}
	 ...
	 */
	public void setVoteReplys (java.util.Set<com.hx.cms.entity.assist.CmsVoteReply> voteReplys) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.hx.cms.entity.assist.CmsVoteSubTopic)) return false;
		else {
			com.hx.cms.entity.assist.CmsVoteSubTopic cmsVoteSubTopic = (com.hx.cms.entity.assist.CmsVoteSubTopic) obj;
