<#--自定义组件
type："1":"字符串文本","2":"整型文本","3":"浮点型文本","4":"文本区","5":"日期","6":"下拉列表","7":"复选框","8":"单选框","9":"自定义"
name
label
help
value
...
<#elseif type=="9">
<@p.text id=name colspan=colspan width=width label=label name=name value=value size=size help=help helpPosition=helpPosition vld=vld/>
<#else>
